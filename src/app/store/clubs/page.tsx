...
export default function StorePage() {
    ...
    const clubsData = sortedData.filter((item) => item.club);
    return (
        <main className="max-w-screen-2xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8 mt-[11vh] bg-white">
            <nav aria-label="Breadcrumb">
                <ol className="flex items-center gap-1 text-sm text-gray-600">
                    ...
                    <li>
                        <a href="/store" className="block transition hover:text-gray-700"> Tienda </a>
                    </li>
                    ...
                    <li>
                        <a href="#" className="block transition hover:text-gray-700"> Clubes </a>
                    </li>
                </ol>
            </nav>
            <Store jerseys={clubsData} />
        </main>
    )
}
