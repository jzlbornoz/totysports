...
const Footer = () => {
    return (
        <footer className="p-4 bg-white border-secundary sm:p-6 dark:bg-third border-t-solid dark:border-gray-800 border-t-2">
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href="#" className="flex items-center">
                            <Image src={Logo} className="mr-3 h-10" alt="FlowBite Logo" width={50} height={60} />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TOTY Sports</span>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="https://flowbite.com" className="hover:underline">TOTY Sports™</Link>. All Rights Reserved.
                    </span>
